From andersl@csd.uu.se Fri Jun 20 09:00:19 1997
Xref: CERN.ch gnu.emacs.sources:6105
Path: CERN.ch!EU.net!chi-news.cic.net!su-news-hub1.bbnplanet.com!news.bbnplanet.com!newsfeed.nacamar.de!news-xfer.cybernet.dk!news.algonet.se!uab.ericsson.se!erinews.ericsson.se!news.seinf.abb.se!news.mdh.se!columba.udac.uu.se!news
From: Anders Lindgren <andersl@csd.uu.se>
Newsgroups: gnu.emacs.sources
Subject: ctypes V1.2
Date: 12 Jun 1997 21:37:31 +0200
Organization: Uppsala University
Lines: 1747
Sender: andersl@groucho.csd.uu.se
Message-ID: <ubdn2ovmx38.fsf@groucho.csd.uu.se>
X-Newsreader: Gnus v5.3/Emacs 19.34
X-IMAPbase: 1200940230 1
Status: O
X-Status: 
X-Keywords:                       
X-UID: 1

Ctypes is a program that enhance font-lock when fontifying C and C++
source code that contain custom defined types and classes.

This is a bug-fix release.  The difference compared to V1.1 is that
this version doesn't re-fontify all buffers when a new buffer is
visited.  Also, the code has been cleared up a bit.  (I just
discovered the beautiful `dolist' macro in the `cl' package.)
