From weiner@infodock.com Thu Dec  5 10:03:55 1996
Xref: CERN.ch gnu.emacs.sources:5664
x-gateway: relay6.UU.NET from gnu-emacs-sources to gnu.emacs.sources; Mon, 2 Dec 1996 22:58:34 EST
Date: Mon, 2 Dec 1996 19:59:23 -0800
From: weiner@infodock.com (Bob Weiner)
Message-ID: <199612030359.TAA14233@infodock.com>
Subject: id-select.el 1.4.3 - Improved selection of larger and larger syntax-driven regions in a buffer.
Newsgroups: gnu.emacs.sources
Path: CERN.ch!EU.net!newsfeed.internetmci.com!in2.uu.net!192.48.96.16!wendy-fate.uu.net!gnu-emacs-sources
Sender: gnu-emacs-sources-request@prep.ai.mit.edu
Lines: 1234
X-IMAPbase: 1200940238 1
Status: O
X-Status: 
X-Keywords:                       
X-UID: 1

This new version supports selection of C++ and Java methods by double clicking
on their first characters or opening and closing braces.

It also supports much improved selection within HTML and SGML modes where
entire tag blocks can be selected by clicking on the first character of an
opening tag.  Textual spans between tags are now selected properly as the
region grows.  A command is provided to move between matching start and end
tags.

If your Emacs supports pasting a region between applications after it has
been deselected, then that functionality will now work with any id-select
region.
